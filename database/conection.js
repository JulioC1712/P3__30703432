...
const sql_create3="CREATE TABLE IF NOT EXISTS imagenes ( id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, url TEXT NOT NULL, destacado TEXT NOT NULL, producto_id INT, FOREIGN KEY (producto_id) REFERENCES productos (id));";
